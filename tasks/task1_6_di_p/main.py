...
from tasks.task1_6_di_p.tsp.filler import TSPStepDocxFiller, TSPLastStepDocxFiller, TSPZeroStepDocxFiller
from tasks.task1_6_di_p.tsp.solver import TSPSolver
