...
from report.model.filler_decorators import formula, formulas_list
...
import tasks.task1_2_lp.document_template.matrix_symplex.util.formula_data as ms_formula_data
