...
from report.model.elements.pretty_elements import replace_in_xml, element_from_string_with_namespaces
...
def _get_element_from_xml_template(filename: str, keys: str | list[str], replacements: str | list[str]):
    ...
    element = element_from_string_with_namespaces(xml, {"m": m, "w": w})[0]
    return element
