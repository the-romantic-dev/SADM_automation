...
from tasks.task2_1_st import task_data as td
import tasks.task2_1_st.config as cfg
from report.docx.objects.document_template import DocumentTemplate
from tasks.task2_1_st.document_template.fill_data.binary_math_model_data import BinaryMathModelData, \
    ChangedBinaryMathModelData
from tasks.task2_1_st.document_template.fill_data.dynamical_moments_data import DynamicalMomentsLatex
from tasks.task2_1_st.document_template.fill_data.math_model_data import MathModelConstraintsLatex, \
    DefaultModelSolutionTableData, IntensiveModelSolutionTableData
from tasks.task2_1_st.document_template.fill_data.math_moments_data import MathMomentsConstraintsLatex, \
    MathMomentsResultTables
from tasks.task2_1_st.document_template.fill_data.probability_data import ProbabilityData
from tasks.task2_1_st.document_template.fill_data.reserves_data import ReservesLatex
from tasks.task2_1_st.document_template.fill_data.scheduling_problem_data import SchedulingProblemData
from tasks.task2_1_st.scheduling_data import SchedulingData
from tasks.task2_1_st.solvers.diagrams.gantt_chart_creator import GanttChartCreator
...
from tasks.task2_1_st.solvers.scheduling_problem.rule import Rule
