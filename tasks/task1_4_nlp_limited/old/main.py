...
from tasks.task1_4_nlp_limited.old.my_docx import docx_output
import sympy as sp
from sympy import Matrix, symbols

from tasks.task1_4_nlp_limited.old.my_docx.fillers.barrier_function_filler import BarrierFunctionDocxFiller
from tasks.task1_4_nlp_limited.old.my_docx.fillers.bill_filler import BillDocxFiller
from tasks.task1_4_nlp_limited.old.my_docx.fillers.frank_wolfe_filler import FrankWolfeDocxFiller
from tasks.task1_4_nlp_limited.old.my_docx.fillers.gradient_projection_filler import GradientProjectionDocxFiller
from tasks.task1_4_nlp_limited.old.my_docx.fillers.penalty_function_filler import PenaltyFunctionDocxFiller
from tasks.task1_4_nlp_limited.old.my_docx.fillers.possible_directions_filler import PossibleDirectionsDocxFiller
from tasks.task1_4_nlp_limited.old.my_docx.optimum_condition_filler import OptimumConditionDocxFiller
from tasks.task1_4_nlp_limited.old.my_io.io import folder
from task import Task
from tasks.task1_4_nlp_limited.old.methods.gradient_projection import GradientProjection
from tasks.task1_4_nlp_limited.old.methods.lagrange import Lagrange
from tasks.task1_4_nlp_limited.old.methods.penalty_funcition_method import PenaltyFunctionMethod
from tasks.task1_4_nlp_limited.old.methods.barrier_funcition_method import BarrierFunctionMethod
from tasks.task1_4_nlp_limited.old.methods.bill.bill import Bill
from tasks.task1_4_nlp_limited.old.methods.frank_wolfe.frank_wolfe import FrankWolfe
from tasks.task1_4_nlp_limited.old.methods.possible_directions import PossibleDirections

from tasks.task1_4_nlp_limited.old.my_docx.fillers.main_filler import main_data_producers
from tasks.task1_4_nlp_limited.old.my_docx.fillers.lagrange_filler import LagrangeDocxFiller
