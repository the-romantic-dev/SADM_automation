...
if __name__ == '__main__':
    ...
    barrier_function.solve(f=Task.f, limitations=Task.lim1234, start=sp.Matrix([1, 1]))
    penalty_function.solve(f=Task.f, limitations=Task.lim1234, start=Matrix([12, -15]))
